...
const scriptVersion = '2026-02-21.1';

let debugPrinted = false;
let runInfoPrinted = false;
...
export default function () {
  ...
  if (debugResponse && !runInfoPrinted) {
    console.log(
      `[debug] register-submit.js version=${scriptVersion}, requireNextPage=${requireNextPage}, minPagesReached=${minPagesReached}, strictSaveSignal=${strictSaveSignal}`,
    );
    runInfoPrinted = true;
  }
